...
class Run extends require('events').EventEmitter {
    ...
    initView = () => {
        ...
        this.view.webContents.setUserAgent(this.step.userAgent ? this.step.userAgent : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/137.0.0.0 Safari/537.36")
