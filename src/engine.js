			...
			switch (node.nodeType) {
				...
				case 1: // element,
					if (node.tagName == 'IFRAME') {
						nodes = node.contentDocument ? [...filterSupportedNodeTypes(node.contentDocument.childNodes, [
							1, // element
							7, // processing instruction
							8  // comment
						]), ...filterSupportedNodeTypes(node.childNodes, [
							1, // element
							3, // text
							4, // CDATASection
							7, // processing instruction
...
export var ebyXPath = XPath => evaluator.evaluate(XPath, document, null, XPathJS.XPathResult.ORDERED_NODE_SNAPSHOT_TYPE)._value